...
$g->table = "gamelist";
$g->select_command = "SELECT games.gamelistid, games.approved, games.tournamentpin, games.emailed, games.gametitle, games.gametype, user.firstname, user.lastname, games.ownerid, games.builtyear, games.manufacturer, games.awards, IF(LENGTH(games.notes) > 0, 'Yes', '') as HasNotes, games.notes 
