...
$g->set_actions(array(	
						...
						"view"=>false, // allow/disallow delete
...
$g->table = "gamelist";
$g->select_command = "SELECT games.gamelistid, games.approved, games.tournamentpin, games.emailed, games.gametitle, games.gametype, user.firstname, user.lastname, games.ownerid, games.builtyear, games.manufacturer, games.awards, games.showyear, IF(LENGTH(games.notes) > 0, 'Yes', '') as HasNotes, games.notes 
 FROM gamelist as games
LEFT JOIN accounts as user on games.ownerid=user.id where games.showyear=" . ($_SESSION['showyear']-1);
...
<html>
  ...
  tr.approved-row
    ...
    <body class="admin">
        ...
        <a href="machines_prior.php" class="selected"><i class="fa-light fa-joystick"></i>Machines Prior</a>
