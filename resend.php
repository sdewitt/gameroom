            ...
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
                        <h3>SFGE Game Bringer Registration</h3>
                        <p>Signup and submit your games for access to all the perks.</p>
                        <div class="page-links">
                            <a href="resend.php" class="active">Login</a><a href="index.php" >Register</a>
                        </div>
    <div class="register">                    
			<form action="resendlogin.php" method="post" autocomplete="off">
				<div class="instructions">NOTICE<br>SFGE does NOT use username/password to access this system. An email was generated at registration and we sent a unique URL that will log you in. If you have misplaced your email please complete the form below and we will email you the link to login.<br><br></div>
				<br>
				<label for="email">
                ...
                <div class="form-button">
                    <button id="submit" type="submit" class="ibtn">Resend</button>
                </div>
